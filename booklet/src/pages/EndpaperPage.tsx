...
export const EndpaperPage: React.FC<{
  ...
  >
    <div style={{ display: "flex", flexDirection: "column", height: "100%" }}>
      ...
      >
        <Fact value="4" unit="ISAs" note="AVX-512 · AVX2 · NEON · wasm128" accent={COLORS.AMBER_DEEP} />
        <Fact value="97.01" unit="% · 10k test" note="9,701 / 10,000 correct" accent={COLORS.GREEN_DEEP} first={false} />
        <Fact value="~1.7×" unit="live median" note="wasm128 vs scalar · p50" accent={COLORS.SKY_DEEP} first={false} />
      </div>
