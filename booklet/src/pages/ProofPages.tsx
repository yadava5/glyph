...
export const ProofSpeedupsPage: React.FC<PageProps> = (p) => {
  ...
  return (
    <BodyPage {...p} sectionLabel="PROOF" sectionColor={GREEN_INK} eyebrow={d.eyebrow} headline={d.headline}>
      ...
      <HangingNote label="The counter-example" accent={COLORS.STEEL} accentInk={COLORS.STEEL_DEEP} style={{ marginTop: 18 }}>
        {d.crossover}
      </HangingNote>
...
export const ProofAccuracyPage: React.FC<PageProps> = (p) => {
  ...
  return (
    <BodyPage {...p} sectionLabel="PROOF" sectionColor={GREEN_INK} eyebrow={d.eyebrow} headline={d.headline}>
      ...
      <HangingNote label="On the record" accent={GREEN} accentInk={GREEN_INK} style={{ marginTop: 22 }}>
        {d.note}
      </HangingNote>
      <SourceNote style={{ marginTop: 16 }}>{d.source}</SourceNote>
    </BodyPage>
...
export const ProofTablePage: React.FC<PageProps> = (p) => {
  ...
  return (
    <BodyPage {...p} sectionLabel="PROOF" sectionColor={GREEN_INK} eyebrow={d.eyebrow} headline={d.headline}>
      ...
      <SourceNote style={{ marginTop: 12 }}>{d.source}</SourceNote>
    </BodyPage>
  );
};
